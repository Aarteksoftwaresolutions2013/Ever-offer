...
%>
<%  
    String merchant_key="hz4zTj";
    String salt="kcIzzgdR";
    String action1 ="";
...
<input type="hidden" name="key" value="<%= merchant_key %>" />
      ...
      <table>
        ...
        <tr>
         ...
         <!--  <td>First Name: </td> -->
          <td><input type="hidden" name="firstname" id="firstname" value="${firstName}" /></td>
        </tr>
        <tr>
          <!-- <td>Email: </td> -->
          <td><input type="hidden" name="email" id="email" value="${email}" /></td>
         <!--  <td>Phone: </td> -->
          <td><input type="hidden" name="phone" value="${number}" /></td>
        </tr>
        <tr>
          <!-- <td>Product Info: </td> -->
